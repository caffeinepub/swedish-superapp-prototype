...
export class Backend implements backendInterface {
    ...
    async getAllLocationRecommendations(): Promise<Array<LocationRecommendation>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllLocationRecommendations();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getLocationRecommendations(arg0: string): Promise<LocationRecommendation> {
        if (this.processError) {
            try {
                const result = await this.actor.getLocationRecommendations(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
